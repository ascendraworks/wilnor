...
export default function Footer() {
  return (
    <footer className="bg-gray-100 px-6 py-12 text-center text-sm text-gray-700">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-3">
          <a
            ...
            className="inline-flex items-center gap-2 animate-pulse bg-orange-500 text-white font-semibold py-3 px-6 rounded-full text-lg shadow hover:bg-orange-600 transition"
          >
            {/* WhatsApp Logo SVG */}
            <svg
        ...
        <div className="space-y-1">
          <p className="font-semibold">Wilnor & Lavett's Employment Pte Ltd</p>
          <p>354 Clementi Ave 2 #01-177A</p>
          <p>Singapore 120354</p>
          <p>WhatsApp: +65 8076 3141</p>
          <p>Email: wilnorlavett.com</p>
        </div>
